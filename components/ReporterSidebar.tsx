...
const navigation: SidebarItem[] = [
  {
    ...
    icon: Home,
    description: 'সংবাদ কেন্দ্র'
  },
  {
    name: 'নিবন্ধ পরিচালনা',
    href: '/reporter/articles',
    icon: FileText,
    description: 'সংবাদ ব্যবস্থাপনা',
    children: [
      { name: 'সব নিবন্ধ', href: '/reporter/articles', icon: FileText, description: 'সকল সংবাদ' },
      { name: 'নতুন নিবন্ধ', href: '/reporter/articles/create', icon: PlusCircle, description: 'নতুন সংবাদ লিখুন' },
      { name: 'খসড়া', href: '/reporter/articles/drafts', icon: Edit, badge: '3', badgeColor: 'bg-amber-500' },
      { name: 'পর্যালোচনায়', href: '/reporter/articles/pending', icon: Clock, badge: '2', badgeColor: 'bg-blue-500' },
      { name: 'প্রকাশিত', href: '/reporter/articles/published', icon: CheckCircle },
      { name: 'প্রত্যাখ্যাত', href: '/reporter/articles/rejected', icon: AlertCircle },
    ]
  },
  {
    name: 'মিডিয়া লাইব্রেরি',
    href: '/reporter/media',
    icon: Camera,
    description: 'ছবি ও ভিডিও',
    children: [
      { name: 'সব মিডিয়া', href: '/reporter/media', icon: Camera },
      { name: 'ছবি আপলোড', href: '/reporter/media/upload', icon: Upload },
      { name: 'ভিডিও', href: '/reporter/media/videos', icon: Video },
      { name: 'গ্যালারি', href: '/reporter/media/gallery', icon: Eye },
    ]
  },
  {
    name: 'পারফরম্যান্স',
    ...
    children: [
      { name: 'অ্যানালিটিক্স', href: '/reporter/analytics', icon: Activity },
      { name: 'ভিউ রিপোর্ট', href: '/reporter/analytics/views', icon: Eye },
      { name: 'এনগেজমেন্ট', href: '/reporter/analytics/engagement', icon: Target },
    ]
  },
  {
    name: 'ক্যালেন্ডার',
    ...
    icon: Calendar,
    description: 'সময়সূচী ব্যবস্থাপনা'
  },
  {
    name: 'বুকমার্ক',
    href: '/reporter/bookmarks',
    icon: Bookmark,
    description: 'সংরক্ষিত আইটেম'
  },
  {
    name: 'নোটিফিকেশন',
    ...
    description: 'বিজ্ঞপ্তি'
  },
  {
    name: 'প্রোফাইল',
    href: '/reporter/profile',
    icon: User,
    description: 'ব্যক্তিগত তথ্য'
  },
  {
    name: 'সেটিংস',
...
export default function ReporterSidebar() {
  ...
  const [expandedItems, setExpandedItems] = useState<string[]>(['/reporter/articles']);
  ...
  if (!mounted) {
    return (
      <div className="w-72 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 h-screen">
              ...
              <div>
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className={`transition-transform duration-200 ${isExpanded(item.href) ? 'rotate-180' : ''}`}>
