  ...
  return (
    <ReporterLayout title="ড্যাশবোর্ড">
      <div className="space-y-8">
        {/* Welcome Section */}
        <div className="bg-linear-to-r from-red-500 via-red-600 to-red-700 rounded-2xl p-8 text-white shadow-2xl">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-3xl font-bold mb-2">স্বাগতম, রিপোর্টার!</h2>
              <p className="text-red-100 text-lg">
                আজ আপনার সংবাদ জগতে নতুন কিছু তৈরি করুন
              </p>
            </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/50">
          <div className="px-8 py-6 border-b border-slate-200/50">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="px-4 py-2 bg-linear-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-200 font-medium shadow-lg"
              >
                সব দেখুন
              </Link>
            </div>
          ...
          <div className="divide-y divide-slate-200/50">
            {myArticles.map((article) => (
              <div
                key={article.id}
                className="p-8 hover:bg-slate-50/50 transition-all duration-200 group"
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 text-sm text-slate-500 mb-3">
                      <span className="bg-linear-to-r from-slate-100 to-slate-200 px-3 py-1 rounded-full font-medium">
                        {article.category}
                      </span>
                  ...
                  <div className="flex items-center space-x-4">
                    <span
                      className={`inline-flex items-center px-4 py-2 text-sm font-semibold rounded-xl ${
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/50 p-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-slate-600 font-medium">
                আপনার সংবাদের পাঠক সংখ্যা
              </p>
            </div>
            <div className="flex items-center space-x-2 text-sm">
              <div className="w-3 h-3 bg-linear-to-r from-red-500 to-red-600 rounded-full"></div>
            ...
            {[
              ...
              >
                <div className="relative w-full flex items-end justify-center mb-2">
                  <div
                    className="w-full bg-linear-to-t from-red-500 via-red-400 to-red-300 rounded-t-2xl hover:from-red-600 hover:via-red-500 hover:to-red-400 transition-all duration-500 cursor-pointer shadow-lg group-hover:shadow-xl relative overflow-hidden"
                    style={{ height: `${item.height * 2}px` }}
                  >
                    <div className="absolute inset-0 bg-linear-to-t from-transparent via-white/10 to-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  </div>
