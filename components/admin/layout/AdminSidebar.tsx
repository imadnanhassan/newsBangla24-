...
const iconMap = {
  LayoutDashboard, FileText, FolderOpen, Users, Image, MessageSquare,
  BarChart3, Settings, Menu, ChevronLeft, User, LogOut, Newspaper,
  Zap, Globe, Video, TrendingUp, Bell, Shield, Rss
};
                ...
                <div key={item.href} className="relative group">
                  <Link
                    ...
                    className={`flex items-center space-x-4 px-4 py-3.5 rounded-2xl transition-all duration-300 group relative overflow-hidden ${
                      isActive
                        ? `bg-gradient-to-r ${item.color} text-white shadow-lg border border-white/10`
