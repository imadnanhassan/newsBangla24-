...
export default function ArticleManagementPage() {
  ...
  const categories = ["Politics", "Sports", "Technology", "National", "Business", "Entertainment", "International"];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage your news articles, drafts, and publications</p>
        </div>
              ...
              {filteredArticles.map((article) => (
                <tr key={article.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      <img className="h-12 w-16 rounded object-cover mr-4" src={article.thumbnail} alt="" />
                      <div>
                        <div className="flex items-center">
                        ...
                        <div className="flex items-center mt-1">
                          <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${getPriorityBadge(article.priority)}`}>
                            {article.priority}
                          </span>
                        </div>
                      </div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {article.publishDate ? new Date(article.publishDate).toLocaleDateString('bn-BD') : '-'}
                  </td>
