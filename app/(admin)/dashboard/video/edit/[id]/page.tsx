...
export default function EditVideoPage() {
  ...
  // SEO optimization
  useEffect(() => {
    document.title = "Edit Video - NewsBangla24 Admin";
  }, []);
    ...
    const loadVideo = async () => {
      ...
      setTimeout(() => {
        setFormData({
          ...
          description:
            "In-depth analysis of the new economic policies and their impact on the national economy.",
          category: "Politics",
          tags: ["politics", "economy", "government"],
          status: "published",
          videoFile: null,
          thumbnail: null,
          seoTitle: "Economic Policy Analysis - Breaking News",
          seoDescription:
            "Latest analysis of economic policies and their impact on Bangladesh.",
        });
        setLoading(false);
      }, 1000);
    };
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                >
                  Update and manage your video content
                </motion.p>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-3">
              ...
              <motion.button
                ...
                className="flex items-center space-x-3 bg-white text-purple-600 px-6 py-3 rounded cursor-pointer font-bold transition-all duration-300"
                whileTap={{ scale: 0.95 }}
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          >
            ...
            >
              <VideoIcon className="w-6 h-6 mr-3 text-purple-600" />
              Video File
            </motion.h3>
              ...
              {formData.videoFile ? (
                ...
                >
                  <div className="bg-gray-100 rounded p-6 text-center">
                    <VideoIcon className="w-16 h-16 text-purple-500 mx-auto mb-4" />
                  ...
                  <div className="absolute inset-0 bg-linear-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 rounded flex items-center justify-center">
                    <div className="flex space-x-4">
                      ...
                      <motion.button
                        ...
                        className="p-3 bg-purple-500 text-white rounded-full shadow-lg hover:bg-purple-600 transition-all duration-300"
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                        title="Replace video"
                      >
                ...
                <motion.div
                  onClick={() => videoInputRef.current?.click()}
                  className="border-2 border-dashed border-gray-300 rounded p-12 text-center cursor-pointer hover:border-purple-500 hover:bg-linear-to-br hover:from-purple-50 hover:to-purple-100 transition-all duration-300 group"
                  whileTap={{ scale: 0.98 }}
                >
                  <motion.div className="w-16 h-16 bg-gray-100 rounded flex items-center justify-center mx-auto mb-6 group-hover:bg-purple-100 transition-colors">
                    <Upload className="w-8 h-8 text-gray-400 group-hover:text-purple-500 transition-colors" />
                  </motion.div>
                  <p className="text-gray-600 group-hover:text-purple-600 transition-colors text-lg font-medium mb-2">
              ...
              {formData.thumbnail ? (
                ...
                >
                  <img
                    ...
                    alt="Thumbnail"
                    className="w-full h-48 object-cover rounded border border-gray-200 shadow-lg"
                  />
                  <div className="absolute inset-0 bg-linear-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 rounded flex items-center justify-center">
                    <div className="flex space-x-4">
                      <motion.button
                ...
                <motion.div
                  onClick={() => thumbnailInputRef.current?.click()}
                  className="border-2 border-dashed border-gray-300 rounded p-12 text-center cursor-pointer hover:border-green-500 hover:bg-linear-to-br hover:from-green-50 hover:to-green-100 transition-all duration-300 group"
                  whileTap={{ scale: 0.98 }}
                >
                  <motion.div className="w-16 h-16 bg-gray-100 rounded flex items-center justify-center mx-auto mb-6 group-hover:bg-green-100 transition-colors">
                    <Upload className="w-8 h-8 text-gray-400 group-hover:text-green-500 transition-colors" />
                  </motion.div>
                  <p className="text-gray-600 group-hover:text-green-600 transition-colors text-lg font-medium mb-2">
                  ...
                  <p className="text-xs text-gray-400">
                    Recommended: 1280x720px for best results
                  </p>
                </motion.div>
              )}
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <motion.button
                  ...
                  className="px-4 py-2 bg-purple-500 text-white rounded hover:bg-purple-600 transition-all duration-300 border border-purple-500"
              ...
              >
                {formData.tags.map((tag, index) => (
                  <motion.span
                    key={index}
                    className="inline-flex items-center px-4 py-2 bg-linear-to-r from-purple-100 to-purple-200 text-purple-800 rounded-full text-sm font-medium border border-purple-300"
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
