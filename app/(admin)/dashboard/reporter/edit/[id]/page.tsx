...
export default function EditReporterPage() {
  ...
  // SEO optimization
  useEffect(() => {
    document.title = "Edit Reporter - NewsBangla24 Admin";
  }, []);
    ...
    const loadReporter = async () => {
      ...
      setTimeout(() => {
        setFormData({
          ...
          avatar: null,
          joinDate: "2022-03-15",
          bio: "Experienced senior reporter specializing in political affairs and economic analysis.",
        });
        setLoading(false);
      }, 1000);
    };
  ...
  const handleSubmit = (status: string) => {
    ...
    console.log("Updated Reporter Data:", reporterData);
    toast.success(
      `Reporter ${
        status === "Active" ? "updated and activated" : "updated"
      } successfully!`
    );
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading reporter...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                >
                  Update reporter information and settings
                </motion.p>
              </div>
            </div>
